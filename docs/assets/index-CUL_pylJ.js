...
const Q = {},
  ...
  ho = /-(\w)/g,
  He = Hn((e) => e.replace(ho, (t, n) => (n ? n.toUpperCase() : ""))),
  go = /\B([A-Z])/g,
  yt = Hn((e) => e.replace(go, "-$1").toLowerCase()),
...
class ei extends Qr {
  ...
  set(t, n, s, r) {
    ...
    if (!this._isShallow) {
      const c = At(i);
      if (
        (!Ne(s) && !At(s) && ((i = j(i)), (s = j(s))), !M(t) && me(i) && !me(s))
      )
    ...
    return (
      t === j(r) && (o ? ht(s, i) && st(t, "set", n, s) : st(t, "add", n, s)), l
    );
  }
  deleteProperty(t, n) {
    const s = J(t, n);
...
function Ho(e, t) {
  const n = {
    ...
    get size() {
      const r = this.__v_raw;
      return !e && xe(j(r), "iterate", It), Reflect.get(r, "size", r);
    },
    has(r) {
      const i = this.__v_raw,
        o = j(i),
...
function hn(e) {
  return At(e) ? e : Ds(e, !1, $o, ko, ti);
}
function Wo(e) {
  return Ds(e, !1, Ro, Bo, ni);
}
function ri(e) {
  return Ds(e, !0, Fo, jo, si);
}
...
function rl(e, t, n = Q) {
  ...
  const k = (T) => {
    if (!(!(u.flags & 1) || (!u.dirty && !T)))
      if (t) {
        const B = u.run();
        if (r || w || (x ? B.some((le, de) => ht(le, V[de])) : ht(B, V))) {
          h && h();
          const le = wt;
          wt = u;
          try {
            const de = [B, V === _n ? void 0 : x && V[0] === _n ? [] : V, m];
            c ? c(t, 3, de) : t(...de), (V = B);
          } finally {
            wt = le;
          }
  ...
  return (
    ...
    t ? (s ? k(!0) : (V = u.run())) : o ? o(k.bind(null, !0), !0) : u.run(),
...
function ln(e, t, n, s, r) {
  const {
    ...
    de = (H, q) => {
      const X = q[1];
      le(H, q),
        M(H) ? H.every((A) => A.length <= 1) && X() : H.length <= 1 && X();
    },
    ve = {
      mode: o,
      persisted: l,
      beforeEnter(H) {
        ...
        H[ut] && H[ut](!0);
        const X = B[T];
        X && Tt(e, X) && X.el[ut] && X.el[ut](), le(q, [H]);
      },
      enter(H) {
        let q = a,
          X = u,
      ...
      leave(H, q) {
        ...
        if ((H[xn] && H[xn](!0), n.isUnmounting)) return q();
        le(h, [H]);
        let A = !1;
        const te = (H[ut] = (pe) => {
          A ||
        ...
        (B[X] = e), m ? de(m, [H, te]) : te();
      },
      clone(H) {
        const q = ln(H, t, n, s, r);
        return r && r(q), q;
      },
    };
  return ve;
...
function wi(e, t, n = !0, s = !1) {
  ...
  if (r) {
    ...
    {
      const l = rc(i, !1);
      if (l && (l === t || l === He(t) || l === kn(He(t)))) return i;
    }
...
const Fi = (e) => e[0] === "_" || e === "$stable",
  ks = (e) => (M(e) ? e.map(Ze) : [Ze(e)]),
  Ll = (e, t, n) => {
    if (t._n) return t;
    const s = he((...r) => ks(t(...r)), n);
    return (s._c = !1), s;
  },
  Ri = (e, t, n) => {
    const s = e._ctx;
  ...
  const {
        ...
        default:
          I & 1
            ...
            : I & 6
              ...
              : (I & 64 || I & 128) && _.process(f, d, g, b, v, y, E, S, C, ke);
      }
    ...
    B = (f, d, g, b, v, y, E, S, C) => {
      d.type === "svg" ? (E = "svg") : d.type === "math" && (E = "mathml"),
        f == null ? le(d, g, b, v, y, E, S, C) : H(f, d, v, y, E, S, C);
    },
    le = (f, d, g, b, v, y, E, S) => {
      let C, _;
        ...
        f == null
          ...
          : I > 0 && I & 64 && O && f.dynamicChildren
            ? (q(f.dynamicChildren, O, g, v, y, E, S),
              (d.key != null || (v && d === v.subTree)) && ki(f, d, !0))
            : Z(f, d, g, L, v, y, E, S, C);
    },
    te = (f, d, g, b, v, y, E, S, C) => {
      (d.slotScopeIds = S),
    ...
    pe = (f, d, g, b, v, y, E) => {
      ...
      if ((Un(f) && (S.ctx.renderer = ke), ec(S, !1, E), S.asyncDep)) {
      ...
      const S = () => {
        if (f.isMounted) {
          ...
          if (
            (Ct(f, !1),
            U && Cn(U),
            !Be && (I = D && D.onVnodeBeforeMount) && ze(I, Y, d),
            Ct(f, !0),
            O && Ut)
          ) {
            const Me = () => {
            ...
            Be && _e.__asyncHydrate ? _e.__asyncHydrate(O, f, Me) : Me();
          } else {
            Pe.ce && Pe.ce._injectChildStyle(_e);
            const Me = (f.subTree = os(f));
            x(null, Me, g, b, f, v, y), (d.el = Me.el);
          }
          if ((ne && De(ne, v), !Be && (I = D && D.onVnodeMounted))) {
            const Me = d;
            De(() => ze(I, Y, Me), v);
          }
          (d.shapeFlag & 256 ||
...
function os(e) {
  ...
  if (V && x !== !1) {
    ...
    T.length &&
      B & 7 &&
      (i && T.some(Ts) && (V = Wl(V, i)), (k = vt(k, V, !1, !0)));
  }
  return (
    n.dirs &&
      ((k = vt(k, null, !1, !0)),
      (k.dirs = k.dirs ? k.dirs.concat(n.dirs) : n.dirs)),
    n.transition && Ot(k, n.transition),
    (F = k),
    Pn(K),
    F
  );
      ...
      return (
        ...
        (c, a) => (
          ...
          Oe(
            ...
            {
              default: he(() => [Et(c.$slots, "default", kr(Bs(c.$attrs)))]),
              _: 3,
            },
            512,
          )
      ...
      const de = t,
          ...
          if (
            ...
            if (
              ...
              const z = T.value.findIndex(({ payload: ce }) => {
                var ke;
                return ce === ((ke = a.value) == null ? void 0 : ke.payload);
              });
              T.value =
                z < P
                  ? [
            ...
            (a.value.destination.index = P),
              (a.value.destination.listItems = B.value);
          }
        },
        H = () => {
          var G;
          if (a.value === void 0) return;
          const P = B.value.indexOf(a.value.payload);
        ...
        pe = (P, { key: G, payload: R }) => {
          ...
          (a.value = {
            ...
            a.value && de("liftItem", j(a.value));
        };
      let Ge;
      const ae = (P, G) => {
          const { target: R, currentTarget: z } = P;
          (o.value.handle &&
            (R == null ? void 0 : R.getAttribute("name")) !== te.value) ||
            (Ge = setTimeout(() => {
              pe(z, G);
            }, o.value.liftDelay));
        },
                  ...
                  ),
                  {
                    default: he(() => [
                      ...
                      Oe(
                        ...
                        {
                          default: he(() => [
                            Et(P.$slots, "before", { arrangedItems: B.value }),
                          ]),
                          _: 3,
                        },
                      )),
                      ...
                      Oe(
                        ...
                        {
                          default: he(() => [
                            Et(P.$slots, "after", { arrangedItems: B.value }),
                          ]),
                          _: 3,
                        },
                        8,
                                ...
                                style: Xe([
                                  {
                                    ...
                                    width:
                                      ((R = W(k)) == null ? void 0 : R.width) +
                                      "px",
                                    height:
                                      ((z = W(k)) == null ? void 0 : z.height) +
                                      "px",
                                    "--landingzone-top":
                                      ((ce = we.value) == null
                                        ? void 0
                ...
                (K = h.destination.listItems) == null ||
                  K.forEach((F, V) => {
                    ...
                    (F.index = V),
                      "listId" in F &&
                        (F.listId =
                          (k = h.destination) == null ? void 0 : k.identifier);
                  }),
