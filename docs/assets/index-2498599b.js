...
function vs(e) {
  ...
  return t && !re(t) && (e.class = it(t)), n && (e.style = on(n)), e;
}
const jo =
...
const Ir = (e) =>
    re(e)
      ...
      : e == null
      ? ""
      : S(e) || (G(e) && (e.toString === Es || !j(e.toString)))
...
function Ls(e = !1) {
  return function (n, r, s, o) {
    ...
    if (
      ...
      return (i.value = s), !0;
    const l = S(n) && Xn(r) ? Number(r) < n.length : q(n, r),
...
function ki(e, t, ...n) {
  ...
  if (i && i in r) {
    const d = `${i === "modelValue" ? "model" : i}Modifiers`,
      { number: h, trim: g } = r[d] || ee;
    g && (s = n.map((w) => (re(w) ? w.trim() : w))), h && (s = n.map(Vo));
  }
  let l,
...
function On(e) {
  ...
  try {
    ...
    (Mt.length = 0), un(z, e, 1), ($ = ie(Ee));
  }
  let F = $;
  if (N && O !== !1) {
    const z = Object.keys(N),
      { shapeFlag: I } = F;
    z.length && I & 7 && (i && z.some(Yn) && (N = Vi(N, i)), (F = Ve(F, N)));
  }
  return (
    n.dirs && ((F = Ve(F)), (F.dirs = F.dirs ? F.dirs.concat(n.dirs) : n.dirs)),
...
function Qs(
  ...
  if (
    (fe(e)
      ...
      : S(e)
      ? ((d = !0),
        (a = e.some((F) => pt(F) || tn(F))),
        (f = () =>
          e.map((F) => {
            if (fe(F)) return F.value;
            if (pt(F)) return ct(F);
            if (j(F)) return ze(F, l, 2);
          })))
      : j(e)
      ? t
        ? (f = () => ze(e, l, 2))
  ...
  let L = d ? new Array(e.length).fill(Vt) : Vt;
  const O = () => {
    if (N.active)
      if (t) {
        const F = N.run();
        (r || a || (d ? F.some((z, I) => Ft(z, L[I])) : Ft(F, L))) &&
          (h && h(),
          we(t, l, 3, [F, L === Vt ? void 0 : d && L[0] === Vt ? [] : L, g]),
          (L = F));
      } else N.run();
  };
  O.allowRecurse = !!t;
...
function Gi(e, t, n) {
  const r = this.proxy,
    s = re(e) ? (e.includes(".") ? Ys(r, e) : () => r[e]) : e.bind(r, r);
  let o;
        ...
        if (g && g.type !== Ee && (!tt(a, g) || w)) {
          ...
          f === "in-out" &&
            ...
            (O.delayLeave = ($, N, D) => {
              ...
              (F[String(g.key)] = g),
                ($._leaveCb = () => {
                  N(), ($._leaveCb = void 0), delete d.delayedLeave;
                }),
                (d.delayedLeave = D);
            });
        }
...
function St(e, t, n, r) {
  const {
    ...
    K = (T, B) => {
      const U = B[1];
      I(T, B),
        S(T) ? T.every((Y) => Y.length <= 1) && U() : T.length <= 1 && U();
    },
    W = {
      mode: o,
      persisted: i,
      beforeEnter(T) {
        ...
        const U = z[F];
        U && tt(e, U) && U.el._leaveCb && U.el._leaveCb(), I(B, [T]);
      },
      enter(T) {
        let B = f,
          U = a,
          Y = d;
        if (!n.isMounted)
          if (s) (B = $ || f), (U = N || a), (Y = D || d);
          else return;
        let P = !1;
        const te = (T._enterCb = (me) => {
          P ||
            ((P = !0),
            me ? I(Y, [T]) : I(U, [T]),
      ...
      leave(T, B) {
        ...
        if ((T._enterCb && T._enterCb(!0), n.isUnmounting)) return B();
        I(h, [T]);
        let Y = !1;
        const P = (T._leaveCb = (te) => {
          Y ||
            ((Y = !0),
            B(),
            te ? I(L, [T]) : I(w, [T]),
...
const Dn = (e) => (e ? (mo(e) ? br(e) || e.proxy : Dn(e.parent)) : null),
  ...
  In = (e, t) => e !== ee && !e.__isScriptSetup && q(e, t),
  dl = {
    get({ _: e }, t) {
      const {
        ctx: n,
      ...
      if (t[0] !== "$") {
        ...
        if (w !== void 0)
          ...
          if (s !== ee && q(s, t)) return (i[t] = 2), s[t];
      ...
      if (n !== ee && q(n, t)) return (i[t] = 4), n[t];
      if (((g = f.config.globalProperties), q(g, t))) return g[t];
    },
    set({ _: e }, t, n) {
...
function pl(e) {
  ...
  if (((jn = !0), o))
    for (const ne in o) {
      const J = o[ne],
        Qe = j(J) ? J.bind(n, n) : j(J.get) ? J.get.bind(n, n) : Ae,
        Ht = !j(J) && j(J.set) ? J.set.bind(n) : Ae,
        Ye = jt({ get: Qe, set: Ht });
  ...
  if (l) for (const ne in l) so(l[ne], r, n, ne);
  if (f) {
    const ne = j(f) ? f.call(n) : f;
  ...
  d && jr(d, e, "c");
  function le(ne, J) {
    S(J) ? J.forEach((Qe) => ne(Qe.bind(n))) : J && ne(J.bind(n));
  }
  if (
    (le(sl, h),
    le(_n, g),
...
function io(e, t, n = !1) {
  ...
  if (!o && !f) return G(e) && r.set(e, ut), ut;
  if (S(o))
    for (let d = 0; d < o.length; d++) {
      const h = _t(o[d]);
      Kr(h) && (i[h] = ee);
    ...
    for (const d in o) {
      ...
      if (Kr(h)) {
        ...
        if (w) {
          const L = Wr(Boolean, w.type),
            O = Wr(String, w.type);
          (w[0] = L > -1),
            (w[1] = O < 0 || L < O),
            (L > -1 || q(w, "default")) && l.push(h);
        }
      }
    }
  const a = [i, l];
...
function El(e, t) {
  return function (r, s = null) {
    j(r) || (r = Object.assign({}, r)), s != null && !G(s) && (s = null);
    const o = ao(),
      i = new Set();
    let l = !1;
    const f = (o.app = {
...
function Un(e, t, n, r, s = !1) {
  ...
  if (
    ...
    if (g || w) {
      const L = () => {
        if (e.f) {
          const O = g ? (q(h, f) ? h[f] : d[f]) : f.value;
          s
            ? S(O) && Jn(O, o)
            : S(O)
...
function Tl(e, t) {
  ...
  const {
      ...
      switch (b) {
        ...
        default:
          E & 1
            ? I(c, u, p, _, m, y, C, v, x)
            : E & 6
            ? te(c, u, p, _, m, y, C, v, x)
            : (E & 64 || E & 128) && b.process(c, u, p, _, m, y, C, v, x, lt);
      }
    ...
    D = (c, u, p, _) => {
      [c.el, c.anchor] = L(c.children, u, p, _, c.el, c.anchor);
    },
    F = ({ el: c, anchor: u }, p, _) => {
      let m;
    ...
    I = (c, u, p, _, m, y, C, v, x) => {
      (C = C || u.type === "svg"),
        c == null ? K(u, p, _, m, y, C, v, x) : B(c, u, m, y, C, v, x);
    },
    K = (c, u, p, _, m, y, C, v) => {
      let x, b;
      const { type: A, props: E, shapeFlag: M, transition: R, dirs: k } = c;
      if (
        ((x = c.el = i(c.type, y, E && E.is, E)),
        M & 8
          ? d(x, c.children)
          : M & 16 &&
            T(c.children, x, null, _, m, y && A !== "foreignObject", C, v),
        ...
        for (const Q in E)
          Q !== "value" &&
            !Yt(Q) &&
            o(x, Q, null, E[Q], y, c.children, _, m, Se);
        "value" in E && o(x, "value", null, E.value),
          (b = E.onVnodeBeforeMount) && $e(b, _, c);
      }
      k && Je(c, null, _, "beforeMount");
      const Z = (!m || (m && !m.pendingBranch)) && R && !R.persisted;
      Z && R.beforeEnter(x),
        r(x, u, p),
        ((b = E && E.onVnodeMounted) || Z || k) &&
          he(() => {
            b && $e(b, _, c), Z && R.enter(x), k && Je(c, null, _, "mounted");
          }, m);
    },
    W = (c, u, p, _, m) => {
      ...
      if (m) {
        ...
        if (u === y) {
          const C = m.vnode;
          W(c, C, C.scopeId, C.slotScopeIds, m.parent);
        }
      }
    },
    T = (c, u, p, _, m, y, C, v, x = 0) => {
      for (let b = x; b < c.length; b++) {
        const A = (c[b] = v ? ke(c[b]) : Le(c[b]));
        O(null, A, u, p, _, m, y, C, v);
      }
    },
    B = (c, u, p, _, m, y, C) => {
      const v = (u.el = c.el);
      ...
      if (
        (b
          ? U(c.dynamicChildren, b, v, p, _, k, y)
          : C || J(c, u, v, null, p, _, k, y, !1),
        x > 0)
      ) {
        if (x & 16) Y(v, u, E, M, p, _, m);
        else if (
          (x & 2 && E.class !== M.class && o(v, "class", null, M.class, m),
          x & 4 && o(v, "style", E.style, M.style, m),
          x & 8)
        ) {
    ...
    P = (c, u, p, _, m, y, C, v, x) => {
      ...
      let { patchFlag: E, dynamicChildren: M, slotScopeIds: R } = u;
      R && (v = v ? v.concat(R) : R),
        c == null
          ? (r(b, p, _), r(A, p, _), T(u.children, p, A, m, y, C, v, x))
          : E > 0 && E & 64 && M && c.dynamicChildren
          ? (U(c.dynamicChildren, M, p, m, y, C, v),
    ...
    le = (c, u, p, _, m, y, C) => {
      const v = () => {
          if (c.isMounted) {
            let { next: A, bu: E, u: M, parent: R, vnode: k } = c,
              Z = A,
              Q;
            Ze(c, !1),
              A ? ((A.el = k.el), ne(c, A, C)) : (A = k),
              E && En(E),
            ...
            let A;
            const { el: E, props: M } = u,
              { bm: R, m: k, parent: Z } = c,
              Q = It(u);
            if (
              (Ze(c, !1),
              R && En(R),
              !Q && (A = M && M.onVnodeBeforeMount) && $e(A, Z, u),
              Ze(c, !0),
              E && Cn)
            ) {
              const se = () => {
                (c.subTree = On(c)), Cn(E, c.subTree, c, m, null);
              };
              Q
              ...
              O(null, se, p, _, c, m, y), (u.el = se.el);
            }
    ...
    J = (c, u, p, _, m, y, C, v, x = !1) => {
      ...
      if (M > 0) {
        if (M & 128) {
          Ht(b, E, p, _, m, y, C, v, x);
          return;
        } else if (M & 256) {
          Qe(b, E, p, _, m, y, C, v, x);
          return;
        }
      }
      R & 8
        ? (A & 16 && Se(b, m, y), E !== b && d(p, E))
        : A & 16
        ? R & 16
          ? Ht(b, E, p, _, m, y, C, v, x)
          : Se(b, m, y, !0)
        : (A & 8 && d(p, ""), R & 16 && T(E, p, _, m, y, C, v, x));
    },
    Qe = (c, u, p, _, m, y, C, v, x) => {
      ...
      for (M = 0; M < E; M++) {
        ...
        O(c[M], R, p, null, m, y, C, v, x);
      }
      b > A ? Se(c, m, y, !0, !1, E) : T(u, p, _, m, y, C, v, x, E);
    },
    Ht = (c, u, p, _, m, y, C, v, x) => {
      ...
      for (; b <= E && b <= M; ) {
        ...
        if (tt(R, k)) O(R, k, p, null, m, y, C, v, x);
        else break;
        b++;
      }
      for (; b <= E && b <= M; ) {
      ...
      if (b > E) {
        if (b <= M) {
          const R = M + 1,
            k = R < A ? u[R].el : _;
          for (; b <= M; )
            O(null, (u[b] = x ? ke(u[b]) : Le(u[b])), p, k, m, y, C, v, x), b++;
        }
      } else if (b > M) for (; b <= E; ) Me(c[b], m, y, !0), b++;
      else {
        const R = b,
          k = b,
          Z = new Map();
    ...
    Ye = (c, u, p, _, m = null) => {
      ...
      if (C === de) {
        r(y, u, p);
        for (let E = 0; E < x.length; E++) Ye(x[E], u, p, _);
        r(c.anchor, u, p);
        return;
      }
      if (C === Pn) {
      ...
      if (_ !== 2 && b & 1 && v)
        if (_ === 0) v.beforeEnter(y), r(y, u, p), he(() => v.enter(y), m);
          ...
          const { leave: E, delayLeave: M, afterLeave: R } = v,
            k = () => r(y, u, p),
            Z = () => {
              E(y, () => {
                k(), R && R();
    ...
    Me = (c, u, p, _ = !1, m = !1) => {
      ...
      const R = A & 1 && M,
        k = !It(c);
      let Z;
      if ((k && (Z = C && C.onVnodeBeforeUnmount) && $e(Z, u, c), A & 6))
        No(c.component, p, _);
      else {
        if (A & 128) {
        ...
        R && Je(c, null, u, "beforeUnmount"),
          A & 64
            ...
            : b && (y !== de || (E > 0 && E & 64))
            ? Se(b, u, p, !1, !0)
            : ((y === de && E & 384) || (!m && A & 16)) && Se(x, u, p),
          _ && Cr(c);
      }
      ((k && (Z = C && C.onVnodeUnmounted)) || R) &&
        he(() => {
          Z && $e(Z, u, c), R && Je(c, null, u, "unmounted");
        }, p);
    },
    Cr = (c) => {
    ...
    wr = (c, u, p) => {
      c == null
        ...
        : O(u._vnode || null, c, u, null, null, null, p),
        Br(),
        zs(),
        (u._vnode = c);
    },
  ...
  Al = {
    ...
    process(e, t, n, r, s, o, i, l, f, a) {
      const {
          ...
          pc: h,
          pbc: g,
          o: { insert: w, querySelector: L, createText: O, createComment: $ },
        } = a,
        N = At(t.props);
      let { shapeFlag: D, children: F, dynamicChildren: z } = t;
      if (e == null) {
        const I = (t.el = O("")),
          K = (t.anchor = O(""));
        w(I, n, r), w(K, n, r);
        const W = (t.target = kn(t.props, L)),
          T = (t.targetAnchor = O(""));
        W && (w(T, W), (i = i || zr(W)));
        const B = (U, Y) => {
          D & 16 && d(F, U, Y, s, o, i, l, f);
        };
        N ? B(n, K) : W && B(W, T);
      } else {
        t.el = e.el;
        ...
        if (
          ((i = i || zr(K)),
          z
            ? (g(e.dynamicChildren, z, B, s, o, i, l), hr(e, t, !0))
            : f || h(e, t, B, U, s, o, i, l, !1),
          N)
        )
          T || Qt(t, n, I, a, 1);
        else if ((t.props && t.props.to) !== (e.props && e.props.to)) {
          const Y = (t.target = kn(t.props, L));
          Y && Qt(t, Y, null, a, 0);
        } else T && Qt(t, K, W, a, 1);
      }
      uo(t);
...
function Ll(e, t = null, n = null, r = 0, s = null, o = !1) {
  ...
  if ((Kl(e) && (e = e.__vccOpts), t)) {
    ...
    l && !re(l) && (t.class = it(l)),
      G(f) && (js(f) && !S(f) && (f = ce({}, f)), (t.style = on(f)));
  }
  const i = re(e) ? 1 : Ji(e) ? 128 : Pl(e) ? 64 : G(e) ? 4 : j(e) ? 2 : 0;
...
function Yl(e, t, n) {
  const r = e.style,
    s = re(n);
  if (n && !s) {
    if (t && !re(t)) for (const o in t) n[o] == null && qn(r, o, "");
...
function vo(e) {
  ...
  const {
    ...
    $ = L && L[1],
    {
      ...
      onBeforeAppear: K = N,
      onAppear: W = D,
      onAppearCancelled: T = F,
    } = t,
    B = (P, te, me) => {
      Ue(P, te ? d : l), Ue(P, te ? a : i), me && me();
    },
    U = (P, te) => {
      (P._isLeaving = !1), Ue(P, h), Ue(P, w), Ue(P, g), te && te();
    },
    Y = (P) => (te, me) => {
      const wt = P ? W : D,
        le = () => B(te, P, me);
      Xe(wt, [te, le]),
        ns(() => {
          Ue(te, P ? f : o), Be(te, P ? d : l), ts(wt) || rs(te, r, O, le);
        });
    };
  return ce(t, {
    onBeforeEnter(P) {
      Xe(N, [P]), Be(P, o), Be(P, i);
    },
    onBeforeAppear(P) {
      Xe(K, [P]), Be(P, f), Be(P, a);
    },
    onEnter: Y(!1),
    onAppear: Y(!0),
    onLeave(P, te) {
      ...
      Be(P, h),
        ...
        Be(P, g),
        ns(() => {
          P._isLeaving && (Ue(P, h), Be(P, w), ts(z) || rs(P, r, $, me));
        }),
        Xe(z, [P, me]);
    },
    onEnterCancelled(P) {
...
function uf(e) {
  ...
  if (G(e)) return [Fn(e.enter), Fn(e.leave)];
  {
    const t = Fn(e);
    return [t, t];
  }
...
const Ln = Ie(void 0),
    ...
    setup(e, { expose: t, emit: n }) {
      const r = e,
        ...
        a = jt(() => {
          var I;
          return (
            ((I = f.value) == null ? void 0 : I.map(({ payload: K }) => K)) ||
            []
          );
        });
      function d(I) {
        ...
        I.forEach((W) => {
          ...
          const T =
            (B = f.value) == null
              ? void 0
              : B.find(({ payload: U }) => W === U);
          T ? K.push(T) : K.push({ key: Symbol(), payload: W });
        }),
          (f.value = K);
      }
      gt(() => r.list, d);
      const h = (I) => {
          ...
          if (
            ...
            !(
              !s.value ||
              ((K = s.value) == null ? void 0 : K.destination) !== r.name ||
              o(a.value[I])
            ))
          ) {
            if (
              ((s.value.toIndex = I),
              !((W = a.value) != null && W.includes(s.value.payload)))
            )
              (T = f.value) == null ||
                T.splice(I, 0, { payload: s.value.payload, key: s.value.key });
            else if (f.value) {
              const B = f.value.findIndex(({ payload: U }) => {
                var Y;
                return U === ((Y = s.value) == null ? void 0 : Y.payload);
              });
              f.value =
                B < I
                  ? [
                      ...f.value.slice(0, B),
                      ...f.value.slice(B + 1, I + 1),
                      f.value[B],
                      ...f.value.slice(I + 1),
                    ]
                  : [
        ...
        g = () => {
          var I;
          if (s.value !== void 0) {
            const K = a.value.indexOf(s.value.payload);
            K >= 0 && ((I = f.value) == null || I.splice(K, 1)),
        ...
        w = () => {
          s.value &&
            ...
            (s.value.destinationList = a.value));
        };
      let L = 0,
        O = 0;
      const $ = (I, { key: K, payload: W }) => {
          var B, U, Y;
          if (
            (B = r.options) != null &&
            B.handle &&
            ((U = I.target.attributes.getNamedItem("name")) == null
              ? void 0
              : U.value) !== "handle"
          )
            return;
          const T =
            (Y = I.currentTarget) == null ? void 0 : Y.getBoundingClientRect();
          (L = D.x.value - T.x),
            (O = D.y.value - T.y),
            (s.value = {
              payload: W,
              ...
              originList: a.value,
              destination: r.name,
              destinationList: a.value,
              fromIndex: a.value.indexOf(W),
              toIndex: a.value.indexOf(W),
              targets: [r.targets ?? r.group ?? r.name].flat(),
              originItemBoundingBox: T,
              key: K,
            }),
        ...
        N = () => {
          s.value === void 0 ||
            ...
            (n("dropItem", H(s.value)), d(r.list), (s.value = void 0));
        },
        D = $o();
      Xt(document, "pointerup", N);
      const F = Symbol(),
        z = Symbol();
      return (
        t({ arrangedItems: a }),
        _n(() => {
          d(r.list), (document.body.style.touchAction = "none");
        }),
        (I, K) => (
          ye(),
          mt(
            Vn,
            { onPointerLeave: g, onPointerEnter: w },
            {
              default: Ce(() => [
                ie(
                  hf,
                  vs(gr(e.options.listTransition)),
                  {
                    default: Ce(() => [
                      (ye(),
                      st("div", { key: V(F) }, [
                        at(I.$slots, "before", { arrangedItems: V(a) }),
                      ])),
                      (ye(!0),
                      st(
                        de,
                      ...
                      (ye(),
                      st("div", { key: V(z) }, [
                        at(I.$slots, "after", { arrangedItems: V(a) }),
                      ])),
                    ]),
                    _: 3,
                  },
                ...
                mt(Fl, { to: "body" }, [
                  ie(
                    vr,
                    _r(
                      { ref: l, ...e.options.hoverTransition },
                      {
                        style: [
                          {
                            left: V(D).x.value - V(L) + "px",
                            top: V(D).y.value - V(O) + "px",
                          },
  ...
  yn = (e) => (Wi("data-v-2db6b438"), (e = e()), zi(), e),
  rc = { class: "list" },
  sc = yn(() => ve("div", { class: "header" }, "To do:", -1)),
  oc = { class: "listitem bg-teal-200 hover:drop-shadow-lg" },
  ic = yn(() =>
    ve("div", { name: "handle", class: "mr-2 cursor-grab" }, "︙", -1)
  ),
  lc = { class: "listitem bg-teal-200 hover:drop-shadow" },
  fc = { class: "list" },
  cc = yn(() => ve("div", { class: "header" }, "Done:", -1)),
  ac = { class: "listitem bg-fuchsia-200 hover:drop-shadow" },
  uc = yn(() =>
    ve("div", { name: "handle", class: "mr-2 cursor-grab" }, "︙", -1)
  ),
  dc = hn({
    ...
    setup(e) {
      ...
      const s = jt(() =>
          n.value.filter(($) => !$.done).sort(($, N) => $.order - N.order)
        ),
        o = jt(() =>
          n.value.filter(($) => $.done).sort(($, N) => $.order - N.order)
        ),
        i = ($, N) => {
          ...
          (n.value = [
            ...
            {
              order: r++,
              description: (D = $.target) == null ? void 0 : D.value,
              done: N,
            },
          ]),
            ($.target.value = "");
        ...
        l = ($) => {
          var z;
          const N = $.hoverElement.value.style;
          if (((N.transition = "all 0.22s ease"), !$.destination)) {
            Object.assign(N, {
              opacity: 1,
              scale: 1,
              top: $.originItemBoundingBox.top + "px",
              left: $.originItemBoundingBox.left + "px",
            });
            return;
          }
          if ($.destination === h) {
            const I = g.value.getBoundingClientRect(),
              K = $.hoverElement.value.getBoundingClientRect();
            Object.assign(N, {
              top: `${(I.bottom + I.y - K.bottom + K.y) / 2}px`,
              left: `${(I.right + I.x - K.right + K.x) / 2}px`,
              scale: 0,
            }),
              n.value.splice(n.value.indexOf($.payload), 1);
            return;
          }
          ...
          $.toIndex !== void 0
            ? ((F =
                (z = document.getElementsByClassName("pickedItem")[0]) == null
                  ? void 0
                  : z.getBoundingClientRect()),
              $.destinationList.forEach((I, K) => {
                (n.value[n.value.indexOf(I)].order = K),
                  (n.value[n.value.indexOf(I)].done = D);
              }))
            : ((F = (D ? L : w).value.getBoundingClientRect()),
              (n.value[n.value.indexOf($.payload)].done = D)),
            Object.assign(N, {
              top: F.top + "px",
              left: F.left + "px",
              opacity: 1,
              scale: 1,
              backgroundColor: D ? ls.fuchsia[200] : ls.teal[200],
            });
        },
        f = Symbol("Todo list"),
        a = Symbol("Done list"),
...
const pc = (e, t) => {
  ...
  hc = pc(dc, [["__scopeId", "data-v-2db6b438"]]);
Ef(hc).mount("#app");
